    ...
    <div className="bg-gray-100 dark:bg-gray-900 text-black dark:text-white min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 -mt-10 md:-mt-16 relative z-10">
        ...
        >
          ...
          <Link
            href="/contact"
            className="mt-6 inline-block bg-primary text-white px-6 py-3 rounded-lg hover:bg-primary-dark transition-colors"
          >
            Contact Us
          </Link>
        </motion.section>
              ...
              >
                {topRow.concat(topRow).map((partner, index) => (
                  ...
                  >
                    ...
                    />
                    <p className="text-[10px] font-semibold text-center dark:text-gray-300">{partner.name}</p>
                  </div>
                ))}
              </motion.div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
            <div className="bg-white border border-gray-200 dark:bg-gray-800 rounded-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-2">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-primary dark:text-primary">Malawi</h3>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-2">
                <MapPin className="w-5 h-5 text-primary mr-2" />
                <h3 className="text-lg md:text-xl font-semibold text-primary dark:text-primary">Zimbabwe</h3>
              </div>
              <p className="text-sm md:text-base text-gray-700 dark:text-gray-300">
                4 Elsworth<br />
                Belgravia<br />
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 rounded-lg p-6 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-center mb-2">
                <MapPin className="w-5 h-5 text-primary mr-2" />
                <h3 className="text-lg md:text-xl font-semibold text-primary">Zambia</h3>
              </div>
              <p className="text-sm md:text-base text-gray-700 dark:text-gray-300">
                9, Thorn Park<br />
